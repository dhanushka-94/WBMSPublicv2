        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Update customer information - {{ $customer->full_name }}</p>
                </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input 
                                    ...
                                    readonly
                                    class="w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-gray-700 cursor-not-allowed focus:outline-none">
